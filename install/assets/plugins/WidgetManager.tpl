...
$config_showhide = isset($config_showhide) ? $config_showhide: 'show';
if($modx->hasPermission('edit_plugin') AND $config_showhide == 'show') {
	$button_pl_config = '
